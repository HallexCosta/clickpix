import { reactMemoryAdapter } from '../../../src/adapters/reactMemoryAdapter.js'
import { useProducts } from '../../hooks/useProducts'

export const Checkout = () => {
  const checkoutRef = window.React.useRef(null)

  const [getProduct, addProduct, products] = useProducts()
    ...
    >
      ...
      <div className="w-[480px] h-[650px] rounded-md bg-white z-20 relative">
        ...
        <div className="flex justify-between p-4">
          ...
          <button
            data-modal-target="modal-tw"
            data-modal-toggle="modal-tw"
            aria-hidden="true"
            className="text-zinc-400"
            onClick={() => checkoutRef.current.classList.add('hidden')}
          >
            X
          </button>
        </div>
          ...
          <div className="w-3/4 flex flex-col items-center justify-center text-center gap-4">
            <div className="flex items-center justify-center rounded-sm p-2 bg-red-600 w-full">
              <div className="w-6 h-6 fill-white">
                <svg
                  className="sc-jsJBEP cNWWX openpix-order-MuiSvgIcon-root openpix-order-MuiSvgIcon-fontSizeMedium"
                  focusable="false"
                  aria-hidden="true"
                  viewBox="0 0 24 24"
            ...
            <h4 className="text-lg font-bold text-align">
              Pague R$ 0,02 para Teste via Pix
            </h4>
            ...
            <form id="checkout" className="flex flex-col gap-4">
              ...
              <button
                className="w-full text-xs bg-green-500 text-white p-3 rounded-md disabled:text-muted bg-gray-200"
                type="button"
                onClick={() => {
